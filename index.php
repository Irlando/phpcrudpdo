<?php 
    ...
    $action = (isset($_GET['a']) || isset($_POST['a'])) ? (isset($_POST['a']) ? $_POST['a'] : $_GET['a']) : 'index';
...
<head>
  ...
  <title>Irlajp Php pdo mvc</title>
  <link rel="shortcut icon" type="image/png" href="views/styles/src/assets/images/logos/php.png" />
  <link rel="stylesheet" href="views/styles/src/assets/css/styles.min.css" />
</head>
<!---C:\xampp\htdocs\testephp\phpcrudpdo\views\styles\src\assets -->
<body> 
...
<!-- Sidebar Start -->
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="views/styles/src/assets/images/logos/logo-light.svg" alt="" width="60px" />
          </a>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="views/styles/src/assets/images/profile/user-1.jpg" alt="" width="35" height="35" class="rounded-circle">
                </a>
  ...
  <script src="views/styles/src/assets/libs/simplebar/dist/simplebar.js"></script>
